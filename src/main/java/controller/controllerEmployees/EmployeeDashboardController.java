...
public class EmployeeDashboardController {
    ...
    private void handleDashboardClick(ActionEvent event) {
        ...
        navigateToPage(event, "/views/fxml_Employees/EmployeeDashboard.fxml", "Dashboard Nhân Viên"); // Đã sửa
    }

    @FXML
    private void handleBookingClick(ActionEvent event) {
        // Cần thay đổi đường dẫn FXML
        navigateToPage(event, "/views/fxml_Employees/Booking.fxml", "Đặt Vé"); // Đã sửa (giả định Booking.fxml nằm trong fxml_Employees)
    }

    @FXML
    private void handleSellAddonServicesClick(ActionEvent event) {
        // Cần thay đổi đường dẫn FXML
        navigateToPage(event, "/views/fxml_Manager/fxml_Employees/SellAddonServices.fxml", "Bán Dịch Vụ Thêm"); // Đã sửa (giả định SellAddonServices.fxml nằm trong fxml_Employees)
    }

    @FXML
    private void handleSearchCancelTicketClick(ActionEvent event) {
        // Cần thay đổi đường dẫn FXML
        navigateToPage(event, "/views/fxml_Manager/fxml_Employees/SearchCancelTicket.fxml", "Tìm/Hủy Vé"); // Đã sửa (giả định SearchCancelTicket.fxml nằm trong fxml_Employees)
    }
    ...
    private void handleLogoutClick(ActionEvent event) {
        ...
        navigateToPage(event, "/views/fxml_Manager/fxml_Employees/Login.fxml", "Đăng Nhập"); // Đã sửa (giả định Login.fxml nằm trong fxml_Employees)
    }
