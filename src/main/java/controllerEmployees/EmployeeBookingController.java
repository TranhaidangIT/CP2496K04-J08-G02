...
public class EmployeeBookingController {
    ...
    @FXML private void handleDashboardClick(ActionEvent event) { navigateToPage(event, "/fxml_Employees/EmployeeDashboard.fxml", "Dashboard Nhân Viên"); }
    @FXML private void handleBookingClick(ActionEvent event) { navigateToPage(event, "/fxml_Employees/Booking.fxml", "Đặt Vé"); } // Reload trang nếu cần
    @FXML private void handleSellAddonServicesClick(ActionEvent event) { navigateToPage(event, "/fxml_Employees/SellAddonServices.fxml", "Bán Dịch Vụ Thêm"); }
    @FXML private void handleSearchCancelTicketClick(ActionEvent event) { navigateToPage(event, "/fxml_Employees/SearchCancelTicket.fxml", "Tìm/Hủy Vé"); }
    @FXML private void handleLogoutClick(ActionEvent event) { navigateToPage(event, "/fxml_Employees/Login.fxml", "Đăng Nhập"); }
